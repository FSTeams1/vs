...
╠❂➣ [Contact on] เปิด คท
╠❂➣ [Contact off] ปิด คท
╠❂➣ [Auto join on] เปิดมุด
╠❂➣ [Auto join off] ปิดมุด
╠❂➣ [Group cancel] ลบรัน
╠❂➣ [Auto leave on] เปิดไม่เข้าแชทรวม
╠❂➣ [Auto leave off] เข้าแชทรวม
...
╠❂➣ [Mcheck] เช็คดำ
╠❂➣ [Conban,Contactban] คทดำ
╠❂➣ [Cb]
╠❂➣ [Clear ban] ล้างดำ
╠❂➣ [T com]
╠❂➣ [Message Confirmation] ยืนยันข้อความ
╠❂➣ [Mybio: 「Iชื่อเซล] เปลี่ยนชื่อเซล
╠❂➣ [Allbio: ชื่อคิกเก้อ]เปลี่ยนชื่อคิก
...
║─┅═✥(Command In Group)✥═┅─
╠══════════════════ 
╠❂➣ [Link on] เปิดบล็อคลิ้ง
╠❂➣ [Link off] ปิดบล็อคลิ้ง
╠❂➣ [Invite「mid」] เชิญด้วยมิด
╠❂➣ [Kmid: Kick by mid]
╠❂➣ [Ginfo] สถานะห้อง
╠❂➣ [Cancel] ลบค้างเชิญ
╠❂➣ [Backup] คิกเข้า3ต้ว
...
║
╠══════════════════
║•─ ͜͡✫ѕєʟғвот[ Բ∀Һ ცσԵ ℓɨמҽ ԵĦ ]κɪcκєʀ ͜͡✫─•
║ ─────┅═ই۝ई═┅─────
║─┅═✥ Բ∀Һ ცσԵ ℓɨמҽ ԵĦ ✥═┅─
╚══════════════════
"""
...
mid = cl.getProfile().mid
Bots = ["u42465e675d3eaf98312c2a9a418b3ba2"]
self = ["u42465e675d3eaf98312c2a9a418b3ba2"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME IS  Բ∀Һ ცσԵ ℓɨמҽ \n http://line.me/ti/p/~fahsaiiii.2608",
    "lang":"JP",
    "comment":"AutoLike by  Բ∀Һ ცσԵ ℓɨמҽ \n http'//line.me/ti/p/~fahsaiiii.2608",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        cl.sendText(msg.to,"เสร็จเรียบร้อยแล้วค่ะ...")
...
#   Op program in bot  Comment By Googlez  #
        if op.type == 25:
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        cl.sendText(msg.to,"เรียบร้อยแล้วค่ะ...")
                        wait["wblack"] = False
                    else:
                        wait["commentBlack"][msg.contentMetadata["mid"]] = True
                        wait["wblack"] = False
                        cl.sendText(msg.to,"ไม่มีคอมเม้น")
                elif wait["dblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        del wait["commentBlack"][msg.contentMetadata["mid"]]
                        cl.sendText(msg.to,"ล้างดำเรียบร้อย...")
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        cl.sendText(msg.to,"ไม่มีบัญขีดำ...")
...
#======================================================#
            elif msg.text in ["tome all on"," Բ∀Һ all on"]:
                        cl.sendText(msg.to,"─┅══ईह ㏒  Բ∀Һ ცσԵ ℓɨמҽ ㏒ ईह══┅─\n\n[SELF BOT BY Բ∀Һ ცσԵ ℓɨמҽ ]")
                        cl.sendText(msg.to,"รอซักครู่......")
...
#======================================================#
                ...
                cl.inviteIntoGroup(msg.to,[midd])
                        ...
                        cl.sendText(msg.to,"เอ้อ ...มึงนั้นแหล่ะเช็คไรนักหนา")

            elif msg.text in ["ฟ้า","หนูฟ้า","หญิงฟ้า"]:
                        cl.sdndText(msg.to,"มีอะไรคะ")
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Kitsune Bot Բ∀Һ Di semua grup")
                else:
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                        json.dump(wait2, fp, sort_keys=True, indent=4)
                        cl.sendText(msg.to, "เปิดการอ่านอัตโนมัติ\nSet reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                        print wait2
                ...
                cl.sendText(msg.to,"❇️ลบแชทเรียบร้อยแล้ว❇️")
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if x.preventJoinByTicket == True:
                        ...
                        cl.updateGroup(x)
                    gurl = cl.reissueGroupTicket(msg.to)
                    cl.sendText(msg.to,"[ Բ∀Һ ცσԵ ℓɨמҽ ]\n\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
    ...
    if op.type == 13:
        if op.param2 not in Bots:
            if op.param2 in Bots:
                ...
                cl.sendText(op.param1,"❇️INVITE MEMBER TO JOIN THE TIME GROUP❇️ [⏰] " +datetime.today().strftime('%H:%M:%S')) 
        if op.param2 not in Bots:
            if op.param2 in Bots:
                pass
        ...
        cl.sendText(op.param1,"❇️ มีการเชิญสมาชิกเข้าร่วมกลุ่ม ❇️ [⏰] " +datetime.today().strftime('%H:%M:%S'))
    if op.type == 11:
        if op.param2 not in Bots:
            if op.param2 in Bots:
                pass
